...
namespace AppointmentScheduler.Infrastructure.Migrations
{
    ...
    [Migration("20250616115228_AddedPatientDocument")]
    partial class AddedPatientDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentScheduler.Business.Entities.Disease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AppointmentScheduler.Business.Entities.PatientDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("AllergicToMedicationOrSomething")
                        .HasColumnType("bit");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DateOfTransfusion")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("HasBeenInHospital")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("HasRadiationTherapy")
                        .HasColumnType("bit");

                    b.Property<bool>("IsAgreedToTreatment")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHivPositive")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPatientUnhealthy")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPregnant")
                        .HasColumnType("bit");

                    b.Property<bool>("IsTreatedByDoctor")
                        .HasColumnType("bit");

                    b.Property<string>("MedicationsTaking")
                        .HasMaxLength(70)
                        .HasColumnType("nvarchar(70)");
                    ...
                    b.Property<string>("TreatedIllness")
                        .HasMaxLength(70)
                        .HasColumnType("nvarchar(70)");

                    b.Property<bool>("TreatedUnderLocalAnesthesia")
                        .HasColumnType("bit");

                    b.Property<string>("TypeOfTransfusion")
                        .HasMaxLength(70)
                        .HasColumnType("nvarchar(70)");
                    ...
                    b.Property<bool>("WantSixMonthTherapyMessage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AppointmentScheduler.Business.Entities.PatientDocumentDisease", b =>
                {
                    ...
                    b.HasKey("PatientDocumentId", "DiseaseId");

                    b.HasIndex("DiseaseId");

                    b.ToTable("PatientDocumentDisease");
                });
            ...
            modelBuilder.Entity("AppointmentScheduler.Business.Entities.PatientDocumentDisease", b =>
                {
                    b.HasOne("AppointmentScheduler.Business.Entities.Disease", "Disease")
                        .WithMany()
                        .HasForeignKey("DiseaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppointmentScheduler.Business.Entities.PatientDocument", "PatientDocument")
                        .WithMany()
